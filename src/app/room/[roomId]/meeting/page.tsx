  ...
  loading: () => (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100%", background: "#000" }}>
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ color: "var(--text-muted)", fontSize: 14 }}>Loading meeting...</p>
      </div>
    </div>
  ),
});
...
export default function MeetingPage() {
  ...
  if (authLoading || loadingRoom) {
    return (<div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", background: "var(--bg-base)", gap: 16 }}><div className="spinner" style={{ width: 48, height: 48 }} /><p style={{ color: "var(--text-secondary)", fontSize: 14 }}>Loading meeting...</p></div>);
  }

  if (!room) {
    return (<div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--bg-base)" }}><div className="empty-state"><h3>Room not found</h3><p>This meeting room doesn&apos;t exist.</p><button className="btn-primary" style={{ marginTop: 16 }} onClick={() => router.push("/dashboard")}>Back to Dashboard</button></div></div>);
  }
  ...
  if (!joined) {
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 24, background: "var(--bg-base)", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", width: 500, height: 500, borderRadius: "50%", background: "radial-gradient(circle, rgba(34,197,94,0.04) 0%, transparent 70%)", bottom: -150, left: -150, pointerEvents: "none" }} />
        ...
        <div className="page-enter" style={{ width: "100%", maxWidth: 520, position: "relative", zIndex: 1 }}>
          ...
          <div className="card" style={{ padding: 0, overflow: "hidden" }}>
            ...
            <div style={{ height: 200, background: "linear-gradient(135deg, #0a0a12, #111118)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16, position: "relative" }}>
              ...
              <p style={{ fontSize: 13, color: "var(--text-muted)" }}>Camera preview</p>
              {room.isActive && (
            ...
            <div style={{ padding: "28px 32px" }}>
              ...
              <p style={{ fontSize: 14, color: "var(--text-secondary)", marginBottom: 20 }}>{room.subject} • {room.teacherName}</p>
              ...
              <div style={{ display: "flex", gap: 20, padding: "16px 0", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)", marginBottom: 24, flexWrap: "wrap" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  ...
                  <span style={{ fontSize: 13, color: "var(--text-secondary)" }}>{room.participants?.length || 0} enrolled</span>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  ...
                  <span style={{ fontSize: 13, color: room.isActive ? "var(--green)" : "var(--text-secondary)" }}>{room.isActive ? "Live now" : "Not started"}</span>
                </div>
              </div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24, padding: "12px 16px", background: "var(--blue-light)", borderRadius: "var(--radius-md)", border: "1px solid rgba(59,130,246,0.1)" }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: 12, color: "var(--text-muted)" }}>Joining as {isTeacher ? "Host (Teacher)" : "Participant (Student)"}</p>
                </div>
              </div>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                <button className="btn-primary" style={{ flex: 1, padding: "14px 24px", fontSize: 15 }} onClick={async () => {
                  ...
                  {isTeacher ? (room.isActive ? "Rejoin Meeting" : "Start Meeting") : "Join Now"}
                </button>
  ...
  // Active meeting view — dark cinematic
  return (
    <div style={{ height: "100vh", display: "flex", flexDirection: "column", background: "#000", overflow: "hidden" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 16px", background: "var(--bg-surface)", borderBottom: "1px solid var(--border)", zIndex: 20, flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <span className="badge badge-live" style={{ marginLeft: 8 }}>Live</span>
        </div>
