      ...
      <main style={{ maxWidth: 1000, margin: "0 auto", padding: "32px 24px" }}>
        ...
        {recordings.length === 0 ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {recordings.map((rec) => (
              <div key={rec.id} className="glass-card" style={{ padding: "16px 20px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
                <div className="flex items-center gap-3" style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ minWidth: 0 }}>
                    <p style={{ fontSize: 14, fontWeight: 500, color: "var(--color-text-primary)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{rec.title}</p>
                    <p style={{ fontSize: 12, color: "var(--color-text-muted)" }}>
                      By {rec.uploadedBy} • {formatDate(rec.createdAt)}
                ...
                {rec.link ? (
                  ...
                  <span style={{ fontSize: 12, color: "var(--color-text-muted)", padding: "8px 16px" }}>Processing...</span>
                )}
              </div>
            ))}
          </div>
